import React, { lazy, Suspense } from 'react';
   ...
   const marqueComponents: { [key: string]: React.ComponentType } = {
     ...
     'british-motor-corporation': lazy(() => import('./pages/Marques/BritishMotorCorporation')),
     ...
     'triumph-automobiles': lazy(() => import('./pages/Marques/TriumphAutomobiles')),
     'triumph-motorcycles': lazy(() => import('./pages/Marques/TriumphMotorcycles')),
